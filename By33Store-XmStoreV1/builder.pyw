...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("By NQ , XM STORE Grabber Builder")
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "nq.png")), size=(60, 60))
        self.large_test_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "nq.png")), size=(500, 150))
        self.image_icon_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "nq.png")), size=(20, 20))
        ...
        self.font = "Supernova"
        self.iconpath = None
        self.iconbitmap(f"{image_path}nq.ico")

        self.navigation_frame = customtkinter.CTkFrame(self, corner_radius=0)
        self.navigation_frame.grid(row=0, column=0, sticky="nsew")
        self.navigation_frame.grid_rowconfigure(4, weight=1)

        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  By NQ , XM STORE Grabber Builder", image=self.logo_image,
